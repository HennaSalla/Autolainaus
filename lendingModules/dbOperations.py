...
class DbConnection():
    ...
    # Metodi, jolla haetaan ehdot tyättävät rivit
    def filterColumnsFromTable(self, table: str, columns: list, filter: str) -> list | None:
        ...
        # Jos tapahtuu virhe, välitetään se luokkaa käyttävälle ohjelmalle
            ...
            # Selvitetään muodostuiko yhteysolio
            if currentConnection:
                cursor.close() # Tuhotaan yhteys
        
    # Metodi tietojen lukemiseen, taulun valitut sarakkeet
    def readColumsFromTable(self) -> str:
    ...
    # Metodi, jolla haetaan ehdot tyättävät rivit
    def getPgtimestamp(self, table: str, columns: list, filter: str) -> list | None:
        """Filters data from table or viwe according to filter string
